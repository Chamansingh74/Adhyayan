        ...
        <section className="section-hero">
            <div className="container grid grid-two-cols">
                <div className="hero-content">
                    ...
                    <h1>Welcome to Singh Technical</h1>
                    <p>
                        Are you ready to take your businees to the next level width
                        cutting-edge IT solutions? Look no further! At Singh Techinical,
            ...
            <div className="container grid grid-two-cols">
                ...
                <div className="hero-content">
                    ...
                    <p>
                        ...
                        lets discuss how Singh Techinical can help your business thrive in
                        the digital age.  
                    </p>
                    <div className="btn btn-group">
                        <a href="/contact">
